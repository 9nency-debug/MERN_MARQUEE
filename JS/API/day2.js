...
/*
– sequence / code -> executes parallel way. }-> Async JS 
– get -> take data, post -> send data to the server, put-> complitely update the data , patch-> parcially data update, delete: to delete the data from the server.
– GET APIs is only the one which can test on browser
*/

/*
    1]  let products = fetch("https://dummyjson.com/products");
    console.log(products);
*/

/* 
    2] let products = fetch("https://dummyjson.com/products").then((resolve) => {
        console.log(resolve);
    });
    // bcz, in this way you can't see the data from the body ->  body: ReadableStream { locked: false, state: 'readable', supportsBYOB: true },
*/

/*
    3] let products = fetch("https://dummyjson.com/products").then((resolve) => {
        console.log(resolve.json); // data -convertsTo-> readable format may be
    }); 
    // 👆🏻 o/p: [Function: json]
*/

/* 
    4] fetch("https://dummyjson.com/products")
...
/* o/p:   status: 200,
  statusText: '',
  headers: Headers {
    date: 'Thu, 03 Sep 2026 05:37:09 GMT',
    ...
    'x-ratelimit-reset': '1787718814',
    'x-xss-protection': '1; mode=block',
    age: '78083',
    'cache-control': 'no-store',
    'cf-cache-status': 'HIT',
    nel: '{"report_to":"cf-nel","success_fraction":0.0,"max_age":604800}',
    'report-to': '{"group":"cf-nel","max_age":604800,"endpoints":[{"url":"https://a.nel.cloudflare.com/report/v4?s=ADSodjTExMqGC2PrBLgwy1eIEigpGRXWGO5t2zq5Jnzsq0CpET9lsuIY0xYfBcPGMoAtEGw1OQg01%2FuIn080CsL4tQu394UKeW3gR6iacKf430sS5H9Ty5mUAwXOM1SiyO5LWGKmmzqtYDCB"}]}',
    server: 'cloudflare',
    'cf-ray': 'a35266a2a90671b6-BOM'
  },
...
dhavaldabhi@Pranshiv API % node day2.js
[Function: json]
dhavaldabhi@Pranshiv API % node day2.js
{
  products: [
